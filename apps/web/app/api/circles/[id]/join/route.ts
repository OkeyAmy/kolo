import { activateCircle, joinCircle } from '@kolo/core'
...
export async function POST(
  ...
  try {
    ...
    return Response.json({ id: circle.id, code: circle.code, position: member.position })
  }
  catch (error) {
